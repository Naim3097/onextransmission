...
export default function BlogPage() {
  ...
  return (
    <>
      ...
      <section className="relative py-24 md:py-32 bg-gradient-to-br from-red-900/20 via-black to-black overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          >
            ...
            >
              <span className="inline-flex items-center px-4 py-2 rounded-full bg-red-600/10 border border-red-600/20 text-red-400 text-sm font-medium mb-4">
      ...
      {/* Category Filter */}
      <section className="sticky top-16 z-40 py-6 bg-black/95 backdrop-blur-md border-b border-gray-800">
              ...
              >
                ...
                <div className="relative h-48 md:h-52 overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4">
                    <span className="inline-flex items-center bg-red-600 text-white text-xs font-semibold px-3 py-1.5 rounded-full shadow-lg">
                      {post.category}
                    </span>
                  </div>
                ...
                <div className="p-6 flex flex-col flex-grow">
                  {/* Post Meta */}
                  <div className="flex items-center flex-wrap gap-3 text-xs text-gray-400 mb-4">
                  ...
                  {/* Post Title */}
                  <h3 className="text-xl font-bold mb-3 text-white group-hover:text-red-400 transition-colors line-clamp-2 leading-tight">
                    {post.title}
                  </h3>
