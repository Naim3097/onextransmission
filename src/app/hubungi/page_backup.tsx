...
Terima kasih!`
    ...
    window.open(`https://wa.me/${whatsappNumber.replace(/\+/g, '').replace(/\s/g, '')}?text=${encodedMessage}`, '_blank')
  }
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      action: `https://wa.me/${whatsappNumber.replace(/\+/g, '').replace(/\s/g, '')}`,
    ...
    },
    {
      ...
      action: 'https://maps.google.com/?q=3.0738,101.5183',
      ...
      <section className="py-20 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              Cara <span className="text-red-500">Menghubungi</span> Kami
            </motion.h2>
            <motion.p 
              variants={fadeInUp}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {contactInfo.map((info, index) => (
              <motion.div
                ...
                className="bg-gray-900 rounded-2xl p-8 text-center hover:transform hover:scale-105 transition-all duration-300"
              >
                ...
                <motion.a
                  ...
                  className={`inline-flex items-center justify-center px-6 py-3 ${info.color} text-white rounded-lg transition-colors w-full`}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.h2 
              ...
              className="text-3xl md:text-4xl font-bold mb-6"
            >
              Quick <span className="text-red-500">Booking</span>
            </motion.h2>
            <motion.p 
              variants={fadeInUp}
            ...
            >
              <div>
                ...
                <div className="bg-gray-800 rounded-2xl overflow-hidden mb-6">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3984.0738!2d101.5183!3d3.0738!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zM8KwMDQnMjYuNCJOIDEwMcKwMzEnMDUuOCJF!5e0!3m2!1sen!2smy!4v1635000000000!5m2!1sen!2smy"
                    width="100%"
                    height="300"
                    style={{ border: 0 }}
                    allowFullScreen
                ...
                <motion.a
                  href="https://maps.google.com/?q=3.0738,101.5183"
                  target="_blank"
              ...
              <div className="bg-gray-900/50 border border-gray-800 rounded-2xl p-6">
                <h4 className="text-lg font-semibold mb-4 text-red-400">Panduan Arah</h4>
                <ul className="space-y-3 text-gray-300 text-sm">
                  <li className="flex items-start space-x-2">
                    <span className="text-red-500 font-bold">1.</span>
                    <span>Dari Lebuhraya NKVE, keluar Exit 214 (Shah Alam)</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <span className="text-red-500 font-bold">2.</span>
                    <span>Ikut papan tanda ke Jalan Kampung Batu</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <span className="text-red-500 font-bold">3.</span>
                    <span>Masuk ke Jalan Industri 16/12</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <span className="text-red-500 font-bold">4.</span>
                    <span>Bengkel kami di No 15 (sebelah kiri)</span>
                  </li>
                </ul>
              </div>
            </motion.div>
